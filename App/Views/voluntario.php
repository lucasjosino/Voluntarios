                                    ...
                                    <div class="twt-feed blue-bg">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h2 class="text-white display-6">Lucas Josino de Paula</h2>
                                        ...
                                        <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                                <div class="row" style="text-align: center; padding-top: 15px; padding-bottom: 15px;">
                                                    <div class="col-md-6">
                                                        <h4>Email:</h4> lukasj@Live.com
                                                        <h4>CPF:</h4> 143857623
                                                        <h4>RG:</h4> 552314567
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h4>WhatsApp:</h4> (16) 992677388
                                                        <h4>Telefone:</h4> (15) 992674534  
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                    <div class="row" style="text-align: center; padding-top: 15px; padding-bottom: 15px;">
                                                            <div class="col-md-6">
                                                                <h4>Estado:</h4> São Paulo
                                                                <h4>Endereço:</h4> Desembargador Mendes 391
                                                            </div>
                                                            <div class="col-md-6">
                                                                    <h4>Cidade:</h4> Franca
                                                                    <h4>Complemento:</h4> Não há Complemento
                                                                </div>
                                                                <br>
                                                            <div class="col-md-12">
                                            ...
                                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                                    <div class="row" style="text-align: center; padding-top: 15px; padding-bottom: 15px;">
                                                            <div class="col-md-6">
                                                                <h4>Formação:</h4> Ensino Superior completo
                                                            </div>
                                                            <div class="col-md-6">
                                                                <h4>Lattes:</h4> Não há Lattes.
                                                                </div>
                                                                <br>
                                                            <div class="col-md-12">
                                                                    <h4>Observações:</h4> Atuei como mercador em veneza onde vendia joias de forma clandestina, também tive a oportunidade de navegar no atlântico procurando por baleias azuis e ilhas desabrigadas para demarcar território e vender na internet. 
                                                                </div>
                                                    </div>
                                            </div>
                                        </div>
